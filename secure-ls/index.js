  ...
  return /******/ (function (modules) {
    ...
    /******/ [
        ...
        var SecureLS = (function () {
          function SecureLS(config) {
            ...
            this.config.isCompression =
              typeof config.isCompression !== "undefined"
                ? config.isCompression
                : true;
            this.config.encodingType =
              typeof config.encodingType !== "undefined" ||
              config.encodingType === ""
                ? config.encodingType.toLowerCase()
                : _constants2.default.EncrytionTypes.BASE64;

            this.config.useLocalStorage =
              typeof config.useLocalStorage !== "undefined"
            ...
            },
            {
              ...
              value: function get(key, isAllKeysData) {
                ...
                if (this._isCompression || isAllKeysData) {
                  ...
                  deCompressedData = _lzString2.default.decompressFromUTF16(
                    data
                  );
                }
                ...
                if (this._isBase64 || isAllKeysData) {
                  ...
                  if (this._isAES) {
                    bytes = _aes2.default.decrypt(
                      deCompressedData.toString(),
                      this.utils.encryptionSecret
                    );
                  } else if (this._isDES) {
                    bytes = _tripledes2.default.decrypt(
                      deCompressedData.toString(),
                      this.utils.encryptionSecret
                    );
                  } else if (this._isRabbit) {
                    bytes = _rabbit2.default.decrypt(
                      deCompressedData.toString(),
                      this.utils.encryptionSecret
                    );
                  } else if (this._isRC4) {
                    bytes = _rc2.default.decrypt(
                      deCompressedData.toString(),
                      this.utils.encryptionSecret
                    );
                  }
            ...
            },
            {
              ...
              value: function processData(data, isAllKeysData) {
                ...
                if (this._isBase64 || isAllKeysData) {
                  ...
                  if (this._isAES) {
                    encodedData = _aes2.default.encrypt(
                      jsonData,
                      this.utils.encryptionSecret
                    );
                  } else if (this._isDES) {
                    encodedData = _tripledes2.default.encrypt(
                      jsonData,
                      this.utils.encryptionSecret
                    );
                  } else if (this._isRabbit) {
                    encodedData = _rabbit2.default.encrypt(
                      jsonData,
                      this.utils.encryptionSecret
                    );
                  } else if (this._isRC4) {
                    encodedData = _rc2.default.encrypt(
                      jsonData,
                      this.utils.encryptionSecret
                    );
                  }
                ...
                if (this._isCompression || isAllKeysData) {
                  compressedData = _lzString2.default.compressToUTF16(
                    encodedData
                  );
                }
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var utils = {
          ...
          warn: function warn(reason) {
            reason = reason
              ? reason
              : _constants2.default.WarningEnum.DEFAULT_TEXT;
      ...
      /***/ function (module, exports) {
        ...
        WarningTypes[WarningEnum.KEY_NOT_PROVIDED] =
          "Secure LS: Key not provided. Aborting operation!";
        WarningTypes[WarningEnum.META_KEY_REMOVE] =
	 ...
	 */
        ...
        enc._Utf8 = {
          stringify: function stringify(wordArray) {
            try {
              return decodeURIComponent(
                escape(enc.Latin1.stringify(wordArray))
              );
            } catch (e) {
              throw new Error("Malformed UTF-8 data");
            }
        ...
        var LZString = (function () {
          ...
          var LZString = {
            ...
            decompressFromUTF16: function (compressed) {
              ...
              return LZString._decompress(compressed.length, 16384, function (
                index
              ) {
            ...
            decompress: function (compressed) {
              if (compressed == null) return "";
              if (compressed == "") return null;
              return LZString._decompress(compressed.length, 32768, function (
                index
              ) {
